...
public class BookBuyerGuiImpl extends JFrame implements BookBuyerGui {
	...
	private JTextField titleTF, numberOfPagesTF, desiredCostTF, maxCostTF, deadlineTF;
					  		...
					  		maxCost = Integer.parseInt(maxCostTF.getText());
					  		 if (maxCost >= desiredCost) {
					  			...
					  			try {
					  				...
					  				if(numberOfPages>0){
					  					notifyUser("PUT FOR BUY: "+title+"(pages: " + numberOfPages + ")" + " at max "+maxCost+" by "+deadline);	
					  					myAgent.purchase(title, numberOfPages, maxCost, deadline);
					  					}
					  				else 
					  					JOptionPane.showMessageDialog(BookBuyerGuiImpl.this, "Invalid number of pages.", "WARNING", JOptionPane.WARNING_MESSAGE);
					  			}
					  			catch(Exception e0) {
					  				JOptionPane.showMessageDialog(BookBuyerGuiImpl.this, "Invalid number of pages.", "WARNING", JOptionPane.WARNING_MESSAGE);
					  			}
