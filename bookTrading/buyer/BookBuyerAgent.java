...
public class BookBuyerAgent extends Agent {
    ...
    **/
    ...
    addBehaviour(new CyclicBehaviour(this) {
      public void action() {
        ...
        if (info != null) {
          purchase(info.getTitle(), info.getNumberOfPages(), info.getMaxPrice(), info.getDeadline());
        }
        else {
          block();
        }
  ...
  **/
  public void purchase(String title, int numberOfPages, int maxPrice, Date deadline) {
    // the following line is in the book at page 62
    addBehaviour(new PurchaseManager(this, title, numberOfPages, maxPrice, deadline));
  }
  ...
  private class PurchaseManager extends TickerBehaviour {
    ...
    private int maxPrice, numberOfPages;
    private long deadline, initTime, deltaT;

    private PurchaseManager(Agent a, String t, int n, int mp, Date d) {
    ...
    public void onTick() {
      ...
      if (currentTime > deadline) {
        ...
        myAgent.addBehaviour(new BookNegotiator(title, numberOfPages, acceptablePrice, this));
      }
    }
  }
  ...
  **/
  public class BookNegotiator extends ContractNetInitiator {
    ...
    public BookNegotiator(String t, int n, int p, PurchaseManager m) {
