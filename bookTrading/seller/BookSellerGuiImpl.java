...
public class BookSellerGuiImpl extends JFrame implements BookSellerGui {
	...
	private JTextField titleTF, numberOfPagesTF, desiredPriceTF, minPriceTF, deadlineTF;
    ...
    ///////////
		JLabel l = new JLabel("Book to sell:");
		 l.setHorizontalAlignment(SwingConstants.LEFT);
		    ...
		    titleTF.setMinimumSize(new Dimension(70, 20));
		    titleTF.setPreferredSize(new Dimension(70, 20));
		    ...
		    numberOfPagesTF = new JTextField(64);
		    numberOfPagesTF.setMinimumSize(new Dimension(70, 20));
		    numberOfPagesTF.setPreferredSize(new Dimension(70, 20));
		    gridBagConstraints = new GridBagConstraints();
		    gridBagConstraints.gridx = 3;
		    gridBagConstraints.gridy = 0;
		    gridBagConstraints.anchor = GridBagConstraints.NORTHWEST;
		    gridBagConstraints.insets = new Insets(5, 3, 0, 3);
		    rootPanel.add(numberOfPagesTF, gridBagConstraints);
			  		...
			  		try {
				  		...
				  		try {
					  		...
					  		if (minPrice <= desiredPrice) {
					  			try {
					  				numberOfPages = Integer.parseInt(numberOfPagesTF.getText());
					  				if(numberOfPages>0){
					  					myAgent.putForSale(title, numberOfPages, desiredPrice, minPrice, deadline);
					  					notifyUser("PUT FOR SALE: "+title+"(pages: " + numberOfPages + ")" + " between "+desiredPrice+" and "+minPrice+" by "+deadline); 
					  				}
					  				else
					  					JOptionPane.showMessageDialog(BookSellerGuiImpl.this, "Invalid number of pages.", "WARNING", JOptionPane.WARNING_MESSAGE);
					  			}
					  			catch(Exception e0) {
					  				JOptionPane.showMessageDialog(BookSellerGuiImpl.this, "Invalid number of pages.", "WARNING", JOptionPane.WARNING_MESSAGE);
					  			}
